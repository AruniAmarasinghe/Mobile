...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(PrinterActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(PrinterActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(PrinterActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(PrinterActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(PrinterActivity.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(PrinterActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(PrinterActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
            ...
            while (true) {
                try {
                    ...
                    if(bytes>0)
                    {
	                    ...
	                    mHandler.obtainMessage(PrinterActivity.MESSAGE_READ, bytes, -1, buffer)
	                            .sendToTarget();
                    }
                    else
                    {
        ...
        public void write(byte[] buffer) {
            try {
               ...
               /* if (buffer.length > 3000) //
                ...
                mHandler.obtainMessage(PrinterActivity.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
